...
public abstract class DriveCommand extends Command {
  ...
  public DriveCommand(DriveCommandConfig drive) {
  ...
  */
   ...
   */
  public final DriveCommand withLinearSpeedSuppliers(Supplier<Double> xSpeedSupplier,
  ...
  */
  public final DriveCommand withAngularSpeedSupplier(Supplier<Double> omegaSupplier) {
    return new DriveCommandWrapper(this) {
      @Override
  ...
  /**
   * Returns a new wrapped {@link DriveCommand} with field relative set to the desired value
   * @param enabled
   * @return
   */
  public final DriveCommand withFieldRelative(boolean enabled) {
    return new DriveCommandWrapper(this) {
      @Override
  ...
  /**
   * Creates a {@link DriveCommand} builder class with the given config.
  ...
  public static class DriveCommandBuilder {
    ...
    /**
     * Sets the maximum translational and rotational speeds
     * @param translationMetersPerSecond
     * @param angularRadiansPerSecond
     * @return
     */
